...
class Encoder
{
	...
	/**
	 * @var instance of idea\util\Encoder
	 */
	 ...
	 */
	protected function __construct($charset = self::CHARSET_UTF8)
	{
	...
	public function mb_convert_encoding($param, $inCharset = 'GBK', $outCharset = null)
	{
		if (is_array($param)) {
			...
			if ($outCharset === null) {
				$outCharset = $this->_charset;
			}
			$param = mb_convert_encoding($param, $outCharset, $inCharset);
		}
		return $param;
	}

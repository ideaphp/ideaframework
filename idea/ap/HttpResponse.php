...
class HttpResponse extends Response
{
	 ...
	 * @return void
	 */
	public function redirect($url, $message = '', $delay = 3, $statusCode = 302)
	{
		if ($this->headersSent()) {
	 ...
	 * @return void
	 */
	public function headerRefresh($url, $message = '', $delay = 3, $statusCode = 302)
	{
		$this->headersSent(true);
		$this->setStatusCode($statusCode);
		$delay = (int) $delay;
	 ...
	 * @return void
	 */
	public function metaRefresh($url, $message = '', $delay = 3)
	{
		$delay = (int) $delay;

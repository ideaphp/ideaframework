...
use idea\mvc\routes\Route;
use idea\mvc\routes\RouteSupervar;
...
{
	/**
	 * @var instance of idea\mvc\routers\Route 当前的匹配成功的路由类实例
	 */
	 ...
	 * 添加一个路由名和路由类
	 * @param string $name
	 * @param idea\mvc\routes\Route $route
	 * @return idea\mvc\Router
	 */

...
use idea\ap\InvalidArgumentException;
...
class View implements interfaces\View
{
	...
	/**
	 * (non-PHPdoc)
	 * @see idea\mvc\interfaces.View::getEngine()
	 */
	...
	/**
	 * (non-PHPdoc)
	 * @see idea\mvc\interfaces.View::__get()
	 */
	...
	/**
	 * (non-PHPdoc)
	 * @see idea\mvc\interfaces.View::__set()
	 */
	...
	/**
	 * (non-PHPdoc)
	 * @see idea\mvc\interfaces.View::__isset()
	 */
	...
	/**
	 * (non-PHPdoc)
	 * @see idea\mvc\interfaces.View::__unset()
	 */
	...
	/**
	 * (non-PHPdoc)
	 * @see idea\mvc\interfaces.View::assign()
	 */
	...
	/**
	 * (non-PHPdoc)
	 * @see idea\mvc\interfaces.View::fetch()
	 */
	...
	/**
	 * (non-PHPdoc)
	 * @see idea\mvc\interfaces.View::display()
	 */
	 ...
	 * @param array $tplVars
	 * @param array $params
	 * @return idea\mvc\Widget
	 * @throws ErrorException 如果widget类不存在，抛出异常
	 * @throws ErrorException 如果widget类不是idea\mvc\Widget的子类，抛出异常
	 */
	public function createWidget($className, array $tplVars = array(), array $params = array())
	{
		...
		if (!$instance instanceof Widget) {
			throw new ErrorException(sprintf(
				'View Class "%s" is not instanceof idea\mvc\Widget.', $widget
			));
		}
	...
	{
		if ($this->_html === null) {
			$this->_html = new Html($this->charset);
		}
